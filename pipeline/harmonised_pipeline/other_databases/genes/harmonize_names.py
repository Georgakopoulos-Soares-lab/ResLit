...
# RESLIT is the pre-harmonization Reslit genes file (built by
# reslit/genes/build_reslit_genes.py) -- not bundled in this packaged
# pipeline, only the final harmonized/antib_bact output is. Regenerate it by
# running the reslit/genes/ chain up through build_reslit_genes.py first.
RESLIT = str(HERE.parent.parent / "reslit" / "genes" / "Full_list_genes_Reslit.csv")
OTHER_DB = str(HERE / "Full_list_genes_otherDatabases_AlleleCorrected-1_filtered_concatenated_bla_fixed.csv")
