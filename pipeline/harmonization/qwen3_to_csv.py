...
def main():
    ...
    allele_map_path = Path(__file__).parent / 'allele_geneFamily.txt'
    ...
    chrom_path = Path(__file__).parent / 'chromosomalMutationGenes.txt'
    ...
    if not chromosomal_genes:
        pm_path = Path(__file__).parent / 'pointMutationsGenesUniq.txt'
        amr_path = Path(__file__).parent / 'amrGenesUniq.txt'
    ...
    bacteria_path = Path(__file__).parent / 'Bacteria_genes_all.txt'
